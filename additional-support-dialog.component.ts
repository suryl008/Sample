...
export class AdditionalSupportDialogComponent implements OnInit, OnDestroy {
  ...
  submissionComment: string = ""; // FIXED: Added this property
  ...
  private initializeForms(): void {
    ...
    this.documentAddForm = this.fb.group({
      documentDetailsForm: this.fb.group({
        ...
        validityComment: [""],
        // submissionComment removed from here - now handled by ngModel
      }),
    });
  ...
  // Save document - FIXED: Using submissionComment from component property
  saveDocument(): void {
    // Validate form
    this.updateDocumentFormErrors();
    ...
    const documentData = {
      ...
      // Comments - FIXED: Use component property for submissionComment
      validityComment: docDetails.validityComment || "",
      submissionComment: this.submissionComment || "", // Using component property
    ...
    console.log("Saving document with submission comment:", documentData);
  ...
  // Save support - FIXED: Using submissionComment from component property
  saveSupport(): void {
    // Validate form
    this.updateSupportFormErrors();
    ...
    const supportData = {
      ...
      submissionComment: this.submissionComment || "", // FIXED: Using component property
    ...
    console.log(
      "Saving support with submission comment:",
      supportData.submissionComment,
    );
