  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  years: number[] = [];
  claimMonthControl = new FormControl(0);
  claimYearControl = new FormControl(0);
  ...
  public contactNameControls = new Map<string, FormControl>();
  ...
  getContactControl(element: any): FormControl {
