...
export class EmailTemplateComponent implements OnInit {
  ...
  openAddorEditEmailTemplatePopup(event:any, Mode : any){
    const dialogRef = this.dialog.open(EmailTemplatePopUpComponent, {
      ...
      width: "80%",
      height : "80%",
      panelClass: ["communication-overlay"],
      data: {pageName : 'emailTemplate', mode : Mode, headerName : Mode == 'add' ? 'Add Email Template' : 'Edit Email Template', emailData : event},
      autoFocus: false
    });
  }
