...
import { MatChipInputEvent, MatChipGrid, MatChipRow } from "@angular/material/chips";
import {
  UntypedFormGroup,
  UntypedFormBuilder,
  Validators,
...
import { FindingsAddDialogComponent } from "../findings-rules/findings-add-dialog/findings-add-dialog.component";
...
export class FindingsComponent implements OnInit {
  ...
  public findingForm: UntypedFormGroup;
  public user: User;
  ...
  selectedCitation = "";
  selectedFinding = "";
  citationCat = new UntypedFormControl();
  isLoading = false;
  errorMsg!: string;
  minLengthTerm = 3;
  ...
  clearSelection() {
    ...
    this.findingEdit = true;
    this.findingARC = true;
    this.entityLevel = "B";
  }
  clearSelection1() {
  ...
  addFindings() {
    ...
    if (this.mode === 'Add') {
      ...
      if (this.findingResult) {
        ...
        console.log({ arcDetails: this.findingResult }
        );
      }
    }
  }
