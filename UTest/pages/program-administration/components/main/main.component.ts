...
export class MainComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.reviewType = localStorage.getItem('ReviewType') ? localStorage.getItem('ReviewType') : AppSettings.DEFAULT_REVIEW_TYPE;
  ...
  changeReviewType(e: any) {
    ...
    localStorage.setItem('ReviewType', e.value )
    this.reviewType = localStorage.getItem('ReviewType');
    console.log('Session local storage ReviewType', localStorage.getItem('ReviewType'));
