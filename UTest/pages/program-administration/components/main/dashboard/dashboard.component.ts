...
export class DashboardComponent implements OnInit {
  searchProgramsCtrl = new UntypedFormControl();
  ...
  newProgramInfo() {
    // this.programAdministrationService.selectedProgramId = "new";
  ...
  selectedProgramInfo() {
    ...
    // this.programAdministrationService.selectedReviewTypeId =
    //   this.selectedSearchProgram.pgmRvwInfos[0].rvwTypeId;
  ...
  selectedReviewInfo(programData: any = null, redirect = false) {
    ...
    if (programReviews && programReviews.length >= 1) {
      ...
      // this.programAdministrationService.selectedReviewTypeId =
      //   programReview.rvwType;
      // this.programAdministrationService.reviewType = programReview.rvwType;
