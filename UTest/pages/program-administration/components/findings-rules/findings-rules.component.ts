...
export class FindingsRulesComponent implements OnInit {
  ...
  public updateFindingRuleForm: UntypedFormGroup;
  ...
  ngOnInit(): void {
    console.log('Session local storage ReviewType in Finding Rule Page -- ######', localStorage.getItem('ReviewType'))
    let data = [{ quesID: 777, quesNAme: "fiscal", fieldLable: "", FieldName: "" },
    { quesID: 777, quesNAme: "fiscal", fieldLable: "", FieldName: "" },
    { quesID: 787, quesNAme: "fiscal", fieldLable: "", FieldName: "" },
    { quesID: 787, quesNAme: "fiscal", fieldLable: "", FieldName: "" }]
    var uniqueArray = data.reduce(function (a, d) {
      if (a.indexOf(d.quesID) === -1) {
        a.push(d.quesID);
      }
      return a;
    }, []);
